        ...
        <PageWrap>
            ...
            {selectedInn ? (
                <>
                    ...
                    <Drawer>
                        <DrawerHeader>
                            <DrawerTitle>Просмотр ИНН</DrawerTitle>
                        ...
                        <DrawerBody>
                            {detailsLoading ? <LoadingText>Загрузка...</LoadingText> : null}
                                ...
                                <>
                                    <Section>
                                        ...
                                        <InfoGrid>
                                            <InfoCard>
                                                <Label>ИНН</Label>
                                                <Value>{displayOrDash(details.inn)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Код НО</Label>
                                                <Value>{displayOrDash(details.kno)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>ОКТМО</Label>
                                                <Value>{displayOrDash(details.oktmo)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Сотрудники с задолженностью</Label>
                                                <Value>{displayOrDash(details.employeesWithDebt)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Кол-во объектов недвижимости</Label>
                                                <Value>{displayOrDash(details.realEstateCount)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Кол-во земельных участков</Label>
                                                <Value>{displayOrDash(details.landCount)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Кол-во транспортных средств</Label>
                                                <Value>{displayOrDash(details.transportCount)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Адрес</Label>
                                                <Value>{displayOrDash(details.address)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>ОКВЭД</Label>
                                                <Value>{displayOrDash(details.okved)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Наименование</Label>
                                                <Value>{displayOrDash(details.name)}</Value>
                                            </InfoCard>
                                        </InfoGrid>
                                    </Section>
                                    ...
                                    <Section>
                                        ...
                                        <InfoGrid>
                                            <InfoCard>
                                                <Label>2024</Label>
                                                <Value>{displayOrDash(details.revenue?.['2024'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2023</Label>
                                                <Value>{displayOrDash(details.revenue?.['2023'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2022</Label>
                                                <Value>{displayOrDash(details.revenue?.['2022'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2021</Label>
                                                <Value>{displayOrDash(details.revenue?.['2021'])}</Value>
                                            </InfoCard>
                                        </InfoGrid>
                                    </Section>
                                    ...
                                    <Section>
                                        ...
                                        <InfoGrid>
                                            <InfoCard>
                                                <Label>2024</Label>
                                                <Value>{displayOrDash(details.avgHeadcount?.['2024'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2023</Label>
                                                <Value>{displayOrDash(details.avgHeadcount?.['2023'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2022</Label>
                                                <Value>{displayOrDash(details.avgHeadcount?.['2022'])}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>2021</Label>
                                                <Value>{displayOrDash(details.avgHeadcount?.['2021'])}</Value>
                                            </InfoCard>
                                        </InfoGrid>
                                    </Section>
                                    ...
                                    <Section>
                                        ...
                                        <InfoGrid>
                                            <InfoCard>
                                                ...
                                                <Value>{displayOrDash(details.currentSaldoEns)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Задолженность перед регионом с учетом пени, справочная информация</Label>
                                                <Value>{displayOrDash(details.currentRegionDebt)}</Value>
                                            </InfoCard>
                                        </InfoGrid>
                                    </Section>
                                        ...
                                        <HistoryTable>
                                            {previousPeriods.length ? (
                                                previousPeriods.map((row) => (
                                                    <HistoryRow key={row.periodLabel}>
                                                        <div>{row.periodLabel}</div>
                                                        <div>Сальдо ЕНС: {displayOrDash(row.saldoEns)}</div>
                                                        <div>Задолженность перед регионом: {displayOrDash(row.regionDebt)}</div>
                                                    </HistoryRow>
                                                ))
                                            ) : (
                                                <InfoCard>
                                    ...
                                    <Section>
                                        ...
                                        <InfoGrid>
                                            <InfoCard>
                                                <Label>Наличие требования</Label>
                                                <Value>{displayOrDash(details.enforcement?.demandExists)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Наличие решения 46ст</Label>
                                                <Value>{displayOrDash(details.enforcement?.decision46Exists)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Кол-во постановлений 47ст</Label>
                                                <Value>{displayOrDash(details.enforcement?.post47Count)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Остаток задолженности по 47ст</Label>
                                                <Value>{displayOrDash(details.enforcement?.post47DebtRest)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Кол-во ЗВСП по 48ст</Label>
                                                <Value>{displayOrDash(details.enforcement?.zvsp48Count)}</Value>
                                            </InfoCard>
                                            <InfoCard>
                                                <Label>Остаток задолженности по ЗВСП</Label>
                                                <Value>{displayOrDash(details.enforcement?.zvspDebtRest)}</Value>
                                            </InfoCard>
                                        </InfoGrid>
                                    </Section>
                                    ...
                                    <Section>
                                        ...
                                        <EditorGrid>
                                            <Field>
                                                <FieldLabel>Статус комиссии</FieldLabel>
                                                <FieldInput
                                            ...
                                            <Field>
                                                ...
                                                <FieldTextarea
                                                    value={details.commission.impactMeasures || ''}
                                                    onChange={(e) =>
                                                        setDetails((prev) =>
                                                            prev
                                                                ? {
                                            ...
                                            <Field>
                                                ...
                                                <FieldTextarea
                                                    value={details.commission.ogvOmsuParticipation || ''}
                                                    onChange={(e) =>
                                                        setDetails((prev) =>
                                                            prev
                                                                ? {
                                                                    ...
                                                                    commission: {
                                                                        ...prev.commission,
                                                                        ogvOmsuParticipation: e.target.value,
                                                                    },
                                                                }
                                                                : prev,
                                                        )
                                    ...
                                    <Section>
                                        ...
                                        <HistoryList>
                                            {historyChanges.length ? (
                                                historyChanges.map((row, index) => (
                                                    <HistoryChangeCard key={`${row.changedAt}-${index}`}>
                        ...
                        <DrawerFooter>
                            ...
                            <Button
                                ...
                                disabled={detailsSaving || detailsLoading || !details}
                            >
